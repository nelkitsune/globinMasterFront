  ...
  return (
    <div className='grid grid-columns-1 md:grid-cols-3 gap-4 mt-4'>
      <div className='grid grid-rows-2 gap-4'>
        <div className='bg-[var(--card)] border border-[var(--card)] rounded shadow-sm align-middle p-2'>Turno Actual: {nombreTurnoActual}</div>
        <div className='bg-[var(--card)] border border-[var(--card)] rounded shadow-sm align-middle p-2'>Asalto: {asalto}</div>
      </div>
      <div>
