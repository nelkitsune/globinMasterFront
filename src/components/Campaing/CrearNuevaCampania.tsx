...
export const CrearNuevaCampania = () => {
    return (
        <div className='bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-lg border-2 border-dashed border-yellow-400 hover:border-yellow-500 hover:shadow-xl transition-all duration-300 p-6 sm:p-8 flex flex-col items-center justify-center gap-4 w-full h-full min-h-[320px]'>
